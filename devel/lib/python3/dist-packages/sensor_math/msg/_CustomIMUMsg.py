...
"""autogenerated by genpy from sensor_math/CustomIMUMsg.msg. Do not edit."""
import codecs
import sys
...
class CustomIMUMsg(genpy.Message):
  _md5sum = "e5caa9162e195ad161e6e93fe1f83380"
  _type = "sensor_math/CustomIMUMsg"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """#CustomIMUMsg.msg
Header header
...
string frame_id
"""
  __slots__ = ['header','acceleration','gyroscope','magnetometer']
  _slot_types = ['std_msgs/Header','float32[3]','float32[3]','float32[3]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,acceleration,gyroscope,magnetometer
    ...
    """
    if args or kwds:
      super(CustomIMUMsg, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_3f().pack(*self.magnetometer))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.magnetometer = _get_struct_3f().unpack(str[start:end])
      return self
